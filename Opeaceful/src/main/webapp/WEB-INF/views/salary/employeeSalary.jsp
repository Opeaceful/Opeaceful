...
<!-- 페이지 css  -->
<link rel="stylesheet"
	href="${path}/resources/css/salary/employeeSalary.css">
...
<body>
	...
	<div class="content-wrap">
		<div class="container">
			...
			<div class="d-inline-flex print-none">
				<select class="form-select form-select-sm print-none"
					id="salary-year" name="year">
				</select> <select class="form-select form-select-sm ms-1 print-none"
			...
			<!-- Modal -->
			<div class="modal fade" id="salary-modal" data-bs-backdrop="static"
				...
				<div
					...
					<div class="modal-content">
							...
							<div class="container">
								<div>
									<div class="salary-btn print-none">
										<button type="button" class="btn" id="print-button">
								...
								<div class="row f-nowrap">
									...
									<div class="hstack gap-3">
										<div>
											<b>직원명 : </b> ${loginUser.getUserName()}
										</div>
										<div>
											<b>부서 : </b> ${loginUser.getDName()}
										</div>
										<div>
											<b>직급 : </b> ${loginUser.getPName()}
										</div>
									</div>
									<div id="payDay"></div>
								</div>
						...
						<div class="modal-footer" id="footer-salary-payment"></div>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="module"
		src="${path}/resources/js/salary/employeeSalary.js"></script>
</body>
</html>