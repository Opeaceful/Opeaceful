...
<link rel="stylesheet" href="<%= request.getContextPath() %>/resources/css/orgChartEnroll.css">
</head>
<body>
	...
	<script src="<%= request.getContextPath() %>/resources/js/orgChartEnroll.js"></script>
</body>
</html>