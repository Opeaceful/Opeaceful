...
<!-- 페이지 CSS-->
<link rel="stylesheet"
	href="${path}/resources/css/common/memberSelect.css">
</head>
<body>
		...
		<div
			...
			<div class="modal-content" id="all-user-view-content">
				...
				<div class="modal-header">
					...
					<button type="button" class="btn-close" id="all-uesr-btn-close"
					...
					<div>
						<form>
							<table class="table table-hover table-common"
								...
								<thead>
									<tr>
										<th scope="col" class="W-10"><input
											class="form-check-input" type="checkbox" id="all-tcode"
											data-key="A1"></th>
										<th scope="col">팀명</th>
										<th scope="col" class="W-10"><input
											class="form-check-input" type="checkbox" id="all-userName"
											data-key="" disabled></th>
										<th scope="col">성명</th>
									</tr>
								</thead>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary ms-1 ok-common"
						id="all-member-modal-button" data-dismiss="modal">확인</button>
				</div>
