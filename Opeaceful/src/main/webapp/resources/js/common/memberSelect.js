...
function checkboxEventListeners() {
    ...
    //팀 체크박스에 이벤트 부여
    const TeamCheckboxes = document.querySelectorAll('#all-member-table tbody th input[type="checkbox"]');
    ...
    AllCheckboxes.addEventListener('click', function(){
        const TeamCheckboxes = document.querySelectorAll('#all-member-table tbody input[type="checkbox"]');
    ...
    //성명 체크박스에 이벤트 부여
    const UserCheckboxes = document.querySelectorAll('#all-member-table tbody td input[type="checkbox"]');
...
function checkMember(){
    //체크된 체크박스 확인 
    const checkboxes = document.querySelectorAll('#all-member-table td input[type="checkbox"]:checked');
    checkMemberNo = [];
    //해당 값 
