...
BEGIN
    DECLARE i INT DEFAULT 1; -- ⓑ i변수 선언, defalt값으로 1설정
     WHILE (i <= 12) DO -- ⓒ for문 작성(i가 1000이 될 때까지 반복)
 		INSERT INTO salary (USER_NO,YEAR_REPORTED,MON_REPORTED,PAYMENT_DATE,TOTAL_GROSSPAY,TOTAL_DEDUCTIONS,NET_PAY,PAYMENTS,DEDUCTION,P_NAME,DEPT_NAME)
	    VALUES
        (8, 2023, i,'2023-06-05','3,750,000', '515,500', '3,234,500', '기본급,3000000,식대,100000,주휴수당,500000,기타수당,150000', '국민연금,120000,건강보험,143500,고용보험,87000,소득세,150000,지방소득세,15000', '부장', '인사팀'),
        (14, 2023, i,'2023-06-12', '3,950,000', '398,900', '3,551,100', '기본급 ,3500000,식대,100000,주휴수당,350000', '국민연금,100000,건강보험,110000,고용보험,80000,소득세,99000,지방소득세,9900', '대리', '영업팀'),
	    (16, 2023, i, '2023-06-15', '4,100,000', '634,000', '3,466,000', '기본급,4000000,식대,100000', '국민연금,180000,건강보험,190000,고용보험,99000,소득세,150000,지방소득세,15000', '과장', '마케팅팀'),
		( 27, 2023, i, '2023-06-21', '3,600,000', '343,200', '3,256,800', '기본급,3500000,식대,100000', '국민연금,140000,건강보험,120000,고용보험,70000,소득세,12000,지방소득세,1200', '차장', '서비스개발팀'),
		(8, 2022, i,'2022-06-05','3,750,000', '515,500', '3,234,500', '기본급,3000000,식대,100000,주휴수당,500000,기타수당,150000', '국민연금,120000,건강보험,143500,고용보험,87000,소득세,150000,지방소득세,15000', '부장', '인사팀'),
		(14, 2022, i,'2022-06-12', '3,950,000', '398,900', '3,551,100', '기본급 ,3500000,식대,100000,주휴수당,350000', '국민연금,100000,건강보험,110000,고용보험,80000,소득세,99000,지방소득세,9900', '대리', '영업팀'),
		(16, 2022, i, '2022-06-15', '4,100,000', '634,000', '3,466,000', '기본급,4000000,식대,100000', '국민연금,180000,건강보험,190000,고용보험,99000,소득세,150000,지방소득세,15000', '과장', '마케팅팀'),
		(27, 2022, i, '2022-06-21', '3,600,000', '343,200', '3,256,800', '기본급,3500000,식대,100000', '국민연금,140000,건강보험,120000,고용보험,70000,소득세,12000,지방소득세,1200', '차장', '서비스개발팀'),
		(8, 2021, i,'2021-06-05','3,750,000', '515,500', '3,234,500', '기본급,3000000,식대,100000,주휴수당,500000,기타수당,150000', '국민연금,120000,건강보험,143500,고용보험,87000,소득세,150000,지방소득세,15000', '대리', '인사팀'),
        (14, 2021, i,'2021-06-12', '3,950,000', '398,900', '3,551,100', '기본급 ,3500000,식대,100000,주휴수당,350000', '국민연금,100000,건강보험,110000,고용보험,80000,소득세,99000,지방소득세,9900', '사원', '영업팀'),
        (16, 2021, i, '2021-06-15', '4,100,000', '634,000', '3,466,000', '기본급,4000000,식대,100000', '국민연금,180000,건강보험,190000,고용보험,99000,소득세,150000,지방소득세,15000', '차장', '마케팅팀'),
        ( 27, 2021, i, '2021-06-21', '3,600,000', '343,200', '3,256,800', '기본급,3500000,식대,100000', '국민연금,140000,건강보험,120000,고용보험,70000,소득세,12000,지방소득세,1200', '사원', '서비스개발팀');
