...
CREATE TABLE `SALARY` (
	...
	`USER_NAME`	NVARCHAR(6)	NOT NULL	COMMENT '유저이름 급여당시',
	`YEAR_REPORTED`	INT	NOT NULL	COMMENT '급여 귀속년',
	`MON_REPORTED`	INT	NOT NULL	COMMENT '급여 귀속월',
	`PAYMENT_DATE`	DATE	NOT NULL	COMMENT '급여 지급년월',
	`TOTAL_GROSSPAY`	NVARCHAR(100) NOT NULL	COMMENT '급여 지급총액',
	`TOTAL_DEDUCTIONS`	NVARCHAR(100) NOT NULL	COMMENT '급여 공제총액',
	`NET_PAY`	NVARCHAR(100)	NOT NULL COMMENT '급여 실지급액',
...
CREATE TABLE `CHAT_ROOM` (
	...
	`ROOM_TITLE` NVARCHAR(20) NOT NULL COMMENT '채팅방 이름' 
);
...
CREATE TABLE `BOARD` (
	...
	`BOARD_CONTENT`	TEXT(65535)	NOT NULL	COMMENT '글내용',
...
CREATE TABLE `RESIGNED_MEMBER` (
	...
	`RESIGNED_SET_DATE`	DATE NOT NULL DEFAULT (CURRENT_DATE) COMMENT '퇴사등록한 시점'
);
...
CREATE TABLE `APPROVAL` (
	...
	`CONTENT`	TEXT(65535)	NULL	COMMENT '결재 내용',
	`DRAFT_DATE`	DATETIME	NOT NULL	COMMENT '기안일',
	`STATUS`	INT	NOT NULL	DEFAULT 0	COMMENT '결재 상태(진행중0,완료1,임시저장2, 반려-1, 확인한반려 -2)',
...
CREATE TABLE `APPROVAL_FORM` (
	...
	`CONTENT` TEXT(65535)	NULL	COMMENT '양식내용'
);
...
CREATE TABLE `APPROVAL_LINE` (
	...
	`STATUS`	INT	NOT NULL	DEFAULT 0	COMMENT '결재상태(기본0,대기1,승인2,반려-1, 참조용3)',
...
CREATE TABLE `APPROVAL_FILE` (
	...
	`ORIGIN_NAME`	NVARCHAR(100)	 NULL	COMMENT '기존파일명',
...
CREATE TABLE `CHAT_FILE` (
	...
	`ORIGINAL_FILENAME`	NVARCHAR(100)	NULL	COMMENT '기본파일명',
